...
var xhrArsenal = new XMLHttpRequest();
var idSquadra = 45;
var codiceSquadra = "ARS";

xhrArsenal.open('GET', 'http://localhost:8765/recupero-stats/calciatori/' + encodeURIComponent(idSquadra) + '/' + encodeURIComponent(codiceSquadra), true);
xhrArsenal.onload = function () {
    if (xhrArsenal.status === 200) {
        console.log("Risposta del server:", xhrArsenal.responseText);
        ...
        data.forEach(function (item, index) {
            ...
            if (codiceCalciatore) {
                ...
                calciatoreDiv.style.backgroundImage = 'url("images_arsenal/' + codiceCalciatore.toLowerCase() + '.jpg")';
