...
xhr.open('GET', 'http://localhost:8765/lega-tedesca/giornata', true);
...
xhrClassifica.open('GET', 'http://localhost:8765/lega-tedesca/punteggi', true);
...
xhrPartite.open('GET', 'http://localhost:8765/lega-tedesca/ultime-partite', true);
...
function aggiornaPartitePerGiornata(idCampionato, giornata) {
    ...
    xhrGiornata.open('GET', 'http://localhost:8765/lega-tedesca/partite-giornata/' + encodeURIComponent(giornata) + '/' + encodeURIComponent(idCampionato), true);
