...
@RestController
@RequestMapping("/lega-a-italiana")
public class SerieAController {
	
	private RestTemplate restTemplate;
	
	@Autowired
    public SerieAController(RestTemplate restTemplate) {
	...
	public List<Punteggi> getPunteggi() {
	    ...
	    RicercaResponseClassifica ricercaResponse = restTemplate.getForObject("http://localhost:9092/classifica/scelta-campionato/ItaliaA", RicercaResponseClassifica.class);
	...
	public List<PartitaEntity> getUltimePartite() {
		RicercaResponsePartita ricercaResponse = restTemplate.getForObject("http://localhost:9091/partite/ultime-partite/4", RicercaResponsePartita.class);
