...
@RestController
@RequestMapping("/lega-inglese")
public class PremierLeagueController {

	private RestTemplate restTemplate;
	
	@Autowired
    public PremierLeagueController(RestTemplate restTemplate) {
	...
	public List<Punteggi> getPunteggi() {
	    ...
	    RicercaResponseClassifica ricercaResponse = restTemplate.getForObject("http://localhost:9092/classifica/scelta-campionato/Inghilterra", RicercaResponseClassifica.class);
	...
	public List<PartitaEntity> getUltimePartite() {
		RicercaResponsePartita ricercaResponse = restTemplate.getForObject("http://localhost:9091/partite/ultime-partite/6", RicercaResponsePartita.class);
