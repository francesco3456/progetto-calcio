...
@RestController
@RequestMapping("/lega-b-italiana")
public class SerieBController {
	
	private RestTemplate restTemplate;
	
	@Autowired
    public SerieBController(RestTemplate restTemplate) {
	...
	public List<Punteggi> getPunteggi() {
	    ...
	    RicercaResponseClassifica ricercaResponse = restTemplate.getForObject("http://localhost:9092/classifica/scelta-campionato/ItaliaB", RicercaResponseClassifica.class);
	...
	public List<PartitaEntity> getUltimePartite() {
		RicercaResponsePartita ricercaResponse = restTemplate.getForObject("http://localhost:9091/partite/ultime-partite/5", RicercaResponsePartita.class);
