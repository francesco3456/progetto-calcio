...
@RestController
@RequestMapping("/lega-francese")
public class Ligue1Controller {
	
	private RestTemplate restTemplate;
	
	@Autowired
    public Ligue1Controller(RestTemplate restTemplate) {
	...
	public List<Punteggi> getPunteggi() {
	    ...
	    RicercaResponseClassifica ricercaResponse = restTemplate.getForObject("http://localhost:9092/classifica/scelta-campionato/Francia", RicercaResponseClassifica.class);
	...
	public List<PartitaEntity> getUltimePartite() {
		RicercaResponsePartita ricercaResponse = restTemplate.getForObject("http://localhost:9091/partite/ultime-partite/8", RicercaResponsePartita.class);
