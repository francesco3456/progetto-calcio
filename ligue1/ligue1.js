...
xhr.open('GET', 'http://localhost:8765/lega-francese/giornata', true);
...
xhrClassifica.open('GET', 'http://localhost:8765/lega-francese/punteggi', true);
...
xhrPartite.open('GET', 'http://localhost:8765/lega-francese/ultime-partite', true);
...
function aggiornaPartitePerGiornata(idCampionato, giornata) {
    ...
    xhrGiornata.open('GET', 'http://localhost:8765/lega-francese/partite-giornata/' + encodeURIComponent(giornata) + '/' + encodeURIComponent(idCampionato), true);
