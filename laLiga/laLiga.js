...
xhr.open('GET', 'http://localhost:8765/lega-spagnola/giornata', true);
...
xhrClassifica.open('GET', 'http://localhost:8765/lega-spagnola/punteggi', true);
...
xhrPartite.open('GET', 'http://localhost:8765/lega-spagnola/ultime-partite', true);
...
function aggiornaPartitePerGiornata(idCampionato, giornata) {
    ...
    xhrGiornata.open('GET', 'http://localhost:8765/lega-spagnola/partite-giornata/' + encodeURIComponent(giornata) + '/' + encodeURIComponent(idCampionato), true);
