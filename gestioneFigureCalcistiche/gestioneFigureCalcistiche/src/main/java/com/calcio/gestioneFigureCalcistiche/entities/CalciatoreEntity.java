...
public class CalciatoreEntity implements InformazioniTabelle, Persona {
	...
	public CalciatoreEntity(Long idCalciatore, SquadraEntity squadra, String ruoloCalciatore, String nomeCalciatore,
			String cognomeCalciatore, int etaCalciatore, String nazionalitaCalciatore, double altezzaCalciatore,
			int pesoCalciatore, boolean flgCancellatoCalciatore, LocalDateTime dataCreazioneCalciatore,
			LocalDateTime dataModificaCalciatore) {
	...
	public String toString() {
		return "CalciatoreEntity [idCalciatore=" + idCalciatore + ", squadra=" + squadra + ", ruoloCalciatore="
				...
				+ ", flgCancellatoCalciatore=" + flgCancellatoCalciatore + ", dataCreazioneCalciatore="
				+ dataCreazioneCalciatore + ", dataModificaCalciatore=" + dataModificaCalciatore + "]";
	}
