        ...
        data.forEach(function (campionato) {
            ...
            button.addEventListener('click', function() {
                ...
                var safeCampionatoName = campionato.trim().toLowerCase().replace(/\s+/g, '');
                       ...
                       if (safeCampionatoName === 'seriea') {
                             window.location.href = 'serie-a/' + safeCampionatoName + '.html';
                } else if (safeCampionatoName === 'serieb') {
                             window.location.href = 'serie-b/' + safeCampionatoName + '.html';
                } else if (safeCampionatoName === 'premierleague') {
                             window.location.href = 'premier-league/' + safeCampionatoName + '.html';
                } else if (safeCampionatoName === 'bundesliga') {
                             window.location.href = 'bundesliga/' + safeCampionatoName + '.html';
                } else if (safeCampionatoName === 'ligue1') {
                             window.location.href = 'ligue1/' + safeCampionatoName + '.html';
                } else if (safeCampionatoName === 'laliga') {
                             window.location.href = 'laLiga/' + safeCampionatoName + '.html';
                } else {
                             console.log('Il campionato selezionato non è stato controllato correttamente!');
                }
            });
