function toBack() {
        ...
        xhr.open('GET', 'http://localhost:8765/lega-a-italiana/giornate', true);
        ...
        xhrClassifica.open('GET', 'http://localhost:8765/lega-a-italiana/punteggi', true);
        ...
        xhrPartite.open('GET', 'http://localhost:8765/lega-a-italiana/ultime-partite', true);
        ...
        function aggiornaPartitePerGiornata(idCampionato, giornata) {
            ...
            xhrGiornata.open('GET', 'http://localhost:8765/lega-a-italiana/partite-giornata/' + encodeURIComponent(giornata) + '/' + encodeURIComponent(idCampionato), true);
